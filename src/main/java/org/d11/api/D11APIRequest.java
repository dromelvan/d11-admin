...
public abstract class D11APIRequest<T extends Object> extends D11AdminBaseObject {
	...
	public void execute() throws IOException {
		switch (getRequestMethod()) {
			...
			case PUT:
				...
				break;
			default:
				throw new RuntimeException("Request method " + getRequestMethod() + " not implemented.");
		}
	}
	...
	private void handleResponse(HttpURLConnection httpURLConnection) throws IOException {
		if (httpURLConnection.getResponseCode() >= 400) {
			...
			Map<String, D11APIError> d11apiErrorMap = new Gson().fromJson(result, new TypeToken<Map<String, D11APIError>>() {
			}.getType());
